...
import 'package:login/screen/Questions/q6.dart';
    ...
    drawer: Drawer(
      ...
      body: Center(
        child:Column(
          ...
          children: <Widget>[
            Text("The unit of electrical resistance of a conductor is—",style: TextStyle(fontSize: 25,color: Colors.white),),
            ...
            ElevatedButton(
              ...
              child: Text("farad",style: TextStyle(fontSize:20,color:_isPressed==1?Colors.white: Color.fromARGB(255, 180, 192, 240) ,fontFamily: 'OpenSans'))
              ),
            ...
            ElevatedButton(
              ...
              child: Text("ohm",style: TextStyle(fontSize:20,color:_isPressed==2?Colors.white: Color.fromARGB(255, 180, 192, 240)  ,fontFamily: 'OpenSans'))
              ),
            ...
            ElevatedButton(
              ...
              child: Text("ampere",style: TextStyle(fontSize:20,color:_isPressed==3?Colors.white: Color.fromARGB(255, 180, 192, 240) ,fontFamily: 'OpenSans'))
              ),
            ...
            ElevatedButton(
              ...
              child: Text("volt",style: TextStyle(fontSize:20,color:_isPressed==4?Colors.white: Color.fromARGB(255, 180, 192, 240)  ,fontFamily: 'OpenSans'))
              ),
